{
  ...
  in {
    # application
    ${application "x-desktop"} = list ["Helix" "writer"];
    ${application "x-krita"} = list ["krita_kra"];
    ${application "x-zerosize"} = list ["Helix" "writer"];
    ${application "xml"} = list ["Helix" "writer"];
    ${application "zip"} = list ["org.gnome.FileRoller"];
    ${application "edje"} = list ["Helix"];
    ${application "json"} = list ["Helix"];
    ...
    ${image "jpeg"} = list ["feh" "krita_jpeg" "zen" "draw"];
    ${image "jpg"} = list ["feh" "krita_jpg" "zen" "draw"];
    ${image "png"} = list ["feh" "krita_png" "zen" "draw"];
    ${image "svg+xml"} = list ["feh" "krita_svg" "zen" "draw"];

    # text
    ${text "html"} = list ["zen"];
    ${text "plain"} = list ["Helix" "writer"];
    ${text "markdown"} = list ["Helix"];

    # video
    ${video "mp4"} = list ["mpv" "vlc"];
    ${video "x-matroska"} = list ["mpv" "vlc"];
