# https://github.com/Keyitdev/sddm-astronaut-theme/issues/17#issuecomment-2610888161
# sddm-astronaut-them is covered under the GNU General Public License v3.0
{
  stdenvNoCC,
  qt6,
  lib,
